 ...
 /* fetch all category to populate the select fields */
    ...
    useEffect(() => {
      axios.get(`/api/all-category`).then(res =>{
        ...
        /* this get the ID pass from the view page to edit page and use it to 
        to fetch details from the database */
      const product_id = props.match.params.id; // this get the ID from url and assign to product_id
      axios.get(`/api/edit-product/${product_id}`).then(res =>{
         if(res.data.status === 200)
         {
            setProduct(res.data.product);
            setDisplay_image(res.data.product);
    ...
    }, [props.match.params.id, history]);  // ends here 
            ...
            <form onSubmit={updateProduct} encType='multipart/form-data' >
                ...
                <div className="tab-content" id="myTabContent">
                    ...
                    <div className="tab-pane card-body border fade show" id="seo-tags" role="tabpanel" aria-labelledby="seo-tags-tab">
                        <div className='form-group mb-3'>
                            <label>Title</label>
                            <input type="text" name='meta_tile' onChange={handleInput} value={productInput.meta_tile} className='form-control'></input>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-4 form-group mb-3'>
                            ...
                            <img src={`http://localhost:8000/`+display_image.image} alt='product_image' width='100px'/>
